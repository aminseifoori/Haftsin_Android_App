...
public class dbhelper extends SQLiteOpenHelper{
	...
	private static String DB_PATH = "/data/data/com.ampesoftware.haftsin/databases/";
	 
	private static String DB_NAME = "Haftsin";
	...
	private void copyDataBase() throws IOException{
		...
		public String getdatahaftsinstory(){
			
			 Cursor c=myDataBase.rawQuery("select * from Haftsin",null);
			 c.moveToPosition(0);
			 String str=c.getString(2).toString();
			 return str;
		}
		
		public String getsabzehid(int recordid, int fielindex){
			
			 Cursor c=myDataBase.rawQuery("select * from Sabzeh where _id="+recordid,null);
			 c.moveToFirst();
